...
/**
 * Transform Authority byte-integrity proof for the recipe-addressed
 * production Transform CAS.
 *
 * The production CAS directory is keyed by RECIPE identity (`getArtifactHash`),
 * which encodes source + define + config but
 ...
 * (a corrupt-but-present artifact). This module is the single owner of:
 ...
 *
 * We deliberately do NOT `fsync`: it is not required for artifact correctness and
