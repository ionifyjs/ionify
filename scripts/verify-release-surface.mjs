...
const releaseEntry = readme.match(/^### 0\.1\.36 — Cross-platform native runtime$/gm) ?? [];
if (whatsNew.length !== 1 || releaseEntry.length !== 1) {
  throw new Error("README must contain exactly one 0.1.36 What's New entry");
}
